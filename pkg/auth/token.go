...
type TokenManager interface {
	NewJwtToken(id int, email string, username string, age int, audience string) (string, error)
...
func (m *Manager) NewJwtToken(id int, email string, username string, age int, audience string) (string, error) {
	nowTime := time.Now()
